...
def searchForSet(retX, retY, setNum, yr, numPce, origPrc):
    ...
    searchURL = 'https://www.googleapis.com/shopping/search/v1/public' \
                '/products?key=%s&country=US&q=lego+%d&alt=json' % (
        myAPIstr, setNum)
...
def setDataCollect():
    ...
    scrapePage('setHtml/lego10181.html', 'out.txt', 2008, 5922, 299.99)
    scrapePage('setHtml/lego10181.html', 'out.txt', 2009, 3263, 249.99)
